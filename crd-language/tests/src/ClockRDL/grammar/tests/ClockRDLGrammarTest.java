...
public class ClockRDLGrammarTest {
	...
	public ParseTree parse(CharStream cs, String rule) {
		ClockRDLLexer 		lexer 	= new ClockRDLParserConstants.ErrorThrowingLexer(cs);
		CommonTokenStream 	tokens 	= new CommonTokenStream(lexer);
		Parser 				parser 	= new ClockRDLParser(tokens);
		ClockRDLParserConstants.NoErrorsForTest   errorL  = new ClockRDLParserConstants.NoErrorsForTest();
